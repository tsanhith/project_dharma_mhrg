...
graph TD
    ...
    subgraph Event-Driven Processing Pipeline
        ...
        Redis_Tailor --> Tailor[✂️ Tailor Agent]
...
2. **Graceful Degradation**: Deep \	ry/except\ blocks encase all scraping and LLM parsing calls. If Playwright times out or Groq generates invalid JSON, the system does NOT crash.
